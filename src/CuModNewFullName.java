...
class CuModNewFullName {
		...
		for (File ontoFile : listOfFiles) {
		    if (ontoFile.isFile()) {   //OuterIF
				...
				try {
					...
					int index = 120;
					// start from 1 if for pair of properties.
					          ...
					          while (!(NextLine = br.readLine()).contains("ending")) {
		        		       	  ...
		        		       	  if(next.contains("--sub property:"))
					        	  {
		        		       		...
		        		       		System.out.println("newsub------------"+newsub);
					    		    		...
					    		    		//bw.write("	<owl:ObjectProperty rdf:about=\"" + newsub + "\">\n");
					    		    		// comment this out for orphen onbject properties, uncomment for pair of properties
					        	  ...
					        	  if((adjcent = br.readLine()).contains("Super class:"))
					        	  {
					        		  		   	...
					        		  		   	bw.write("		<rdfs:subPropertyOf rdf:resource=\"" + newsuper +"\"/>\n");
	    		   	    			 ...
	    		   	    			 NodeList hasValueList = subClass.getElementsByTagName("owl:hasValue");
	    		    		         	...
	    		    		         	for (int m = 0; m < hasValueList.getLength(); ++m)
	    		    	    		       ...
	    		    	    		       if(!hasValueText.isEmpty()){
	        		    					...
	        		    					br.write("			<owl:Restriction>\n");
	    	    		    				br.write("				<owl:onProperty rdf:resource=\"" + onPropertyText_original + "\"/>\n");
	    	    		    				br.write("				<owl:hasValue rdf:resource=\"" + hasValueText_original + "\"/>\n");
	    	    		    				br.write("			</owl:Restriction>\n");
	    	    		    				br.write("		</rdfs:subClassOf>\n");
	    	    		    				br.write("	</owl:Class>\n\n");
	...
	private static void Cardinality(File listOfFiles,  String axiom, BufferedWriter br) {
	    		...
	    		if (nNode.getNodeType() == Node.ELEMENT_NODE) {
	    	        ...
	    	        for (int k = 0; k < SubClassList.getLength(); ++k)
	    	        {
	    		    	...
	    		    	{		   
	    		    			...
	    		    			String   CardContent="";
	    		    			String   MinCardAttribute="";
	    		    			String   MinCardContent="";
	    		    			String   MaxCardAttribute="";
	    		    			String   MaxCardContent="";
	    		    			 ...
	    		    			 for (int l = 0; l < RestrictionList.getLength(); ++l)
	    		    		        {
	    		    		            ...
	    		    		            NodeList onPropertyList = Restriction.getElementsByTagName("owl:onProperty");
	    		   	    				...
	    		   	    				NodeList cardinalityList = subClass.getElementsByTagName("owl:cardinality");
	    		    		         	for (int m = 0; m < cardinalityList.getLength(); ++m)
	    		    	    		       ...
	    		    	    		       if(!CardAttribute.isEmpty()){
	    		    	    				br.write(" <!-- Cardinality-->\n\n\n\n");		    	
	    		    	    		   		br.write("	<owl:Class rdf:about =\"" + HeadNode_original+ "\">\n");
	        		    					br.write("		<rdfs:subClassOf>\n");
	        		    					br.write("			<owl:Restriction>\n");
	    	    		    				br.write("				<owl:onProperty rdf:resource=\"" + onPropertyText_original + "\"/>\n");
	    	    		    				br.write("				<owl:cardinality rdf:datatype=\"" + CardAttribute + "\"/>"+CardContent+"</owl:cardinality>\n");
	    	    		    				br.write("			</owl:Restriction>\n");
	    	    		    				br.write("		</rdfs:subClassOf>\n");
	    	    		    				br.write("	</owl:Class>\n\n");
	    		    	    		       }
	    		    	    		       ...
	    		    	    		       NodeList MinCardinalityList = subClass.getElementsByTagName("owl:minCardinality");
		    		    		         	for (int m = 0; m < MinCardinalityList.getLength(); ++m)
		    		   	    		        {
		    	   	    		            Element MinCard = (Element) MinCardinalityList.item(m);
		    	   	    		            MinCardAttribute = MinCard.getAttribute("rdf:datatype");
		    	   	    		            MinCardContent = MinCard.getTextContent();
		    		   	    		    	}
		    		    	    		       ...
		    		    	    		       if(!CardAttribute.isEmpty()){
		        		    					...
		        		    					br.write("			<owl:Restriction>\n");
		    	    		    				br.write("				<owl:onProperty rdf:resource=\"" + onPropertyText_original + "\"/>\n");
		    	    		    				br.write("				<owl:minCardinality rdf:datatype=\"" + MinCardAttribute + "\"/>"+MinCardContent+"</owl:minCardinality>\n");
		    	    		    				br.write("			</owl:Restriction>\n");
		    	    		    				br.write("		</rdfs:subClassOf>\n");
		    	    		    				br.write("	</owl:Class>\n\n");
		    		    	    		       }
		    		    	    		       ...
		    		    	    		       NodeList MaxCardinalityList = subClass.getElementsByTagName("owl:minCardinality");
			    		    		         	for (int m = 0; m < MaxCardinalityList.getLength(); ++m)
			    		   	    		        {
			    	   	    		            Element MaxCard = (Element) MaxCardinalityList.item(m);
			    	   	    		            MaxCardAttribute = MaxCard.getAttribute("rdf:datatype");
			    	   	    		            MaxCardContent = MaxCard.getTextContent();
			    		   	    		    	}
			    		    	    		       ...
			    		    	    		       if(!CardAttribute.isEmpty()){
			        		    					...
			        		    					br.write("			<owl:Restriction>\n");
			    	    		    				br.write("				<owl:onProperty rdf:resource=\"" + onPropertyText_original + "\"/>\n");
			    	    		    				br.write("				<owl:minCardinality rdf:datatype=\"" + MaxCardAttribute + "\"/>"+MaxCardContent+"</owl:minCardinality>\n");
			    	    		    				br.write("			</owl:Restriction>\n");
			    	    		    				br.write("		</rdfs:subClassOf>\n");
			    	    		    				br.write("	</owl:Class>\n\n");
			    		    	    		       }   
